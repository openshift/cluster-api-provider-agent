...
func newAgentMachine(name, namespace string, spec capiproviderv1.AgentMachineSpec, ctx context.Context, c client.Client) (*capiproviderv1.AgentMachine, *clusterv1.Machine) {
	...
	cluster := clusterv1.Cluster{
		...
		Spec:   clusterv1.ClusterSpec{InfrastructureRef: clusterv1.ContractVersionedObjectReference{Name: agentCluster.Name}},
...
var _ = Describe("agentmachine reconcile", func() {
	...
	It("agent bind-unbind cleanup", func() {
		...
		conditions.Set(machine, metav1.Condition{Type: string(clusterv1.PreTerminateDeleteHookSucceededV1Beta1Condition), Status: metav1.ConditionFalse, Reason: clusterv1.WaitingExternalHookV1Beta1Reason, Message: ""})
	...
	It("removes the finalizer when the delete hook has already been removed", func() {
		...
		conditions.Set(machine, metav1.Condition{Type: string(clusterv1.PreTerminateDeleteHookSucceededV1Beta1Condition), Status: metav1.ConditionTrue, Message: ""})
		Expect(c.Update(ctx, machine)).To(BeNil())
